...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .beritacontainer { max-width: 1200px; margin: 0 auto; padding: 40px 20px; } /* Main container padding */
        ...
        .news-page-header::before { /* Large bubble bottom left */
            width: 200px;
            height: 200px;
            bottom: -100px;
            left: -50px;
        }
        .news-page-header::after { /* Smaller bubble top right */
            width: 100px;
            height: 100px;
            top: 20px;
            right: 20px;
        ...
        .beritaarticle-card {
            ...
            cursor: pointer;
            display: flex;
            flex-direction: column; /* To make content flex vertically */
        }
        ...
        .beritaarticle-image {
            ...
            position: relative;
            overflow: hidden;
            display: flex; /* For centering content or managing image */
            align-items: center;
        ...
        .beritahiring-badge {
            ...
            z-index: 2; /* Make sure badge is above image */
        }
        ...
        .beritaarticle-excerpt {
            ...
            font-size: 0.95rem;
            line-height: 1.5;
            margin-bottom: auto; /* Pushes content to top, allowing tags/read more to align bottom */
        }
        /* Pagination Styling */
        .pagination-links {
            margin-top: 40px;
        ...
        @media (max-width: 768px) {
            ...
            .beritacontainer { padding: 20px 15px; }
            .news-page-header h1 { font-size: 2.5rem; }
            .news-page-header { padding: 40px 15px; }
            .beritaarticles-grid { grid-template-columns: 1fr; gap: 20px; }
            .beritaarticle-content { padding: 20px; }
        }
    </style>
</head>
<body>

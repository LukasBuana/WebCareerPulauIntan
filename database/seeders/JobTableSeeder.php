...
class JobTableSeeder extends Seeder
{
    ...
    {
        // Pastikan tidak ada data duplikat jika seeder dijalankan berulang kali
        // DB::table('job_categories')->truncate(); // Hanya jika ingin mengosongkan tabel sebelum seeding
        ...
        //     ('WFA', 'NULL', 'NULL', 'NULL', NOW(), NOW()),
        //     ('WFA', 'NULL', 'NULL', 'NULL', NOW(), NOW()),
        //     ('WFO', 'Bandung', 'Jawa Barat', 'Indonesia',NOW(), NOW()),
        //     ('WFO', 'Yogyakarta', 'DI Yogyakarta', 'Indonesia', NOW(), NOW());
